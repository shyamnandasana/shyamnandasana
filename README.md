...
### 🚀 About Me
- 🔭 I am a Full Stack Developer specializing in ASP.NET Core, Web API, MVC
...
### 🛠 Languages and Tools
<p align="left">
<img src="https://skillicons.dev/icons?i=html,css,js,cs,java,dotnet,visualstudio,git,github,postman,mysql,mssql" />

### 📂 Projects
- 🛒 **E-Commerce Web Application** – ASP.NET MVC + Web API + JWT Authentication  
- 📚 **Book Management System** – CRUD operations using ASP.NET Core MVC and Web API
- 🧠 **Quiz Management System** – Quiz-wise question management and generation using ASP.NET MVC
- 📚 **Student Project Management System** - It is a web application built with Next.js that allows students to create, manage, and track their academic projects efficiently.
